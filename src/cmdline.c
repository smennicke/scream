/*
  ...
  gengetopt --input=cmdline.ggo --unamed-opts=FILE --include-getopt --show-required --no-handle-error --conf-parser
...
const char *gengetopt_args_info_purpose = "SCREAM (Staged Configuration of fEAture Models) computes a configuration model,\ncalled Stage Model (SM), out of a feature model (FM).\nTherefore, an FM is represented as a Petri net, which is transformed into a\nworkflow net according to the given stage model. An SM is only a configuration\nmodel if the underlying workflow Petri net is weakly terminating and has no\ndead transitions.";

const char *gengetopt_args_info_usage = "Usage: scream [OPTIONS]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nProduct Input / Stage Model Output:",
  "  -p, --product=FILE            Define the product input method",
  "  -o, --output=FORMAT           Select the output file format(s)  (possible\n                                  values=\"lola\", \"dot\", \"png\", \"pdf\")",
  "\nStage Model Strategies:",
  "  -s, --outer-strategy=STRATEGY Define the outer strategy to compute stage\n                                  models.  (possible values=\"forwards\",\n                                  \"backwards\" default=`forwards')",
  "  -t, --inner-strategy=STRATEGY Define the inner strategy to compute stage\n                                  models.  (possible values=\"first\", \"last\"\n                                  default=`last')",
  "      --all                     If flag is given, all stage models for all\n                                  sequences are computed.  (default=off)",
  "      --try-all                 If flag is given, all sequences are tried to\n                                  find a stage model.  (default=off)",
  "      --all-given-sequence      If flag is given, all stage models for a given\n                                  sequence are computed.  (default=off)",
  "\nStatus Messages and Results:",
  "  -R, --Result                  Prints result to stdout.  (default=off)",
  "  -r, --result[=FILE]           Prints result to specified file. If no filename\n                                  is given, it will be derived from the input\n                                  file.",
  "      --csv[=FILE]              Prints result line in CSV format.",
  "  -L, --Log                     Prints log to stdout  (default=off)",
  "  -l, --log[=FILE]              Prints result to specified file. ...",
  "      --interactive             Stops when a dead transition or an unsound net\n                                  was found  (default=off)",
  "      --basepath=PATH           This is the bin/ path where all the lola tools\n                                  are in.",
    0
};
...
const char *cmdline_parser_output_values[] = {"lola", "dot", "png", "pdf", 0}; /*< Possible values for output. */
const char *cmdline_parser_outer_strategy_values[] = {"forwards", "backwards", 0}; /*< Possible values for outer-strategy. */
const char *cmdline_parser_inner_strategy_values[] = {"first", "last", 0}; /*< Possible values for inner-strategy. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->product_given = 0 ;
  args_info->output_given = 0 ;
  args_info->outer_strategy_given = 0 ;
  args_info->inner_strategy_given = 0 ;
  args_info->all_given = 0 ;
  args_info->try_all_given = 0 ;
  args_info->all_given_sequence_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->product_arg = NULL;
  args_info->product_orig = NULL;
  args_info->output_arg = NULL;
  args_info->output_orig = NULL;
  args_info->outer_strategy_arg = outer_strategy_arg_forwards;
  args_info->outer_strategy_orig = NULL;
  args_info->inner_strategy_arg = inner_strategy_arg_last;
  args_info->inner_strategy_orig = NULL;
  args_info->all_flag = 0;
  args_info->try_all_flag = 0;
  args_info->all_given_sequence_flag = 0;
  args_info->Result_flag = 0;
  args_info->result_arg = NULL;
  args_info->result_orig = NULL;
  args_info->csv_arg = NULL;
  args_info->csv_orig = NULL;
  args_info->Log_flag = 0;
  args_info->log_arg = NULL;
  args_info->log_orig = NULL;
  args_info->interactive_flag = 0;
  args_info->basepath_arg = NULL;
  args_info->basepath_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->product_help = gengetopt_args_info_help[3] ;
  args_info->output_help = gengetopt_args_info_help[4] ;
  args_info->output_min = 0;
  args_info->output_max = 0;
  args_info->outer_strategy_help = gengetopt_args_info_help[6] ;
  args_info->inner_strategy_help = gengetopt_args_info_help[7] ;
  args_info->all_help = gengetopt_args_info_help[8] ;
  args_info->try_all_help = gengetopt_args_info_help[9] ;
  args_info->all_given_sequence_help = gengetopt_args_info_help[10] ;
  args_info->Result_help = gengetopt_args_info_help[12] ;
  args_info->result_help = gengetopt_args_info_help[13] ;
  args_info->csv_help = gengetopt_args_info_help[14] ;
  args_info->Log_help = gengetopt_args_info_help[15] ;
  args_info->log_help = gengetopt_args_info_help[16] ;
  args_info->interactive_help = gengetopt_args_info_help[17] ;
  args_info->basepath_help = gengetopt_args_info_help[18] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->product_arg));
  free_string_field (&(args_info->product_orig));
  free_multiple_field (args_info->output_given, (void *)(args_info->output_arg), &(args_info->output_orig));
  args_info->output_arg = 0;
  free_string_field (&(args_info->outer_strategy_orig));
  free_string_field (&(args_info->inner_strategy_orig));
  free_string_field (&(args_info->result_arg));
  free_string_field (&(args_info->result_orig));
  free_string_field (&(args_info->csv_arg));
  free_string_field (&(args_info->csv_orig));
  free_string_field (&(args_info->log_arg));
  free_string_field (&(args_info->log_orig));
  free_string_field (&(args_info->basepath_arg));
  free_string_field (&(args_info->basepath_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->product_given)
    write_into_file(outfile, "product", args_info->product_orig, 0);
  write_multiple_into_file(outfile, args_info->output_given, "output", args_info->output_orig, cmdline_parser_output_values);
  if (args_info->outer_strategy_given)
    write_into_file(outfile, "outer-strategy", args_info->outer_strategy_orig, cmdline_parser_outer_strategy_values);
  if (args_info->inner_strategy_given)
    write_into_file(outfile, "inner-strategy", args_info->inner_strategy_orig, cmdline_parser_inner_strategy_values);
  if (args_info->all_given)
    write_into_file(outfile, "all", 0, 0 );
  if (args_info->try_all_given)
    write_into_file(outfile, "try-all", 0, 0 );
  if (args_info->all_given_sequence_given)
    write_into_file(outfile, "all-given-sequence", 0, 0 );
  if (args_info->Result_given)
    write_into_file(outfile, "Result", 0, 0 );
  if (args_info->result_given)
    write_into_file(outfile, "result", args_info->result_orig, 0);
  if (args_info->csv_given)
    write_into_file(outfile, "csv", args_info->csv_orig, 0);
  ...
  if (args_info->basepath_given)
    write_into_file(outfile, "basepath", args_info->basepath_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "product",	1, NULL, 'p' },
        { "output",	1, NULL, 'o' },
        { "outer-strategy",	1, NULL, 's' },
        { "inner-strategy",	1, NULL, 't' },
        { "all",	0, NULL, 0 },
        { "try-all",	0, NULL, 0 },
        { "all-given-sequence",	0, NULL, 0 },
        { "Result",	0, NULL, 'R' },
        { "result",	2, NULL, 'r' },
        { "csv",	2, NULL, 0 },
        { "Log",	0, NULL, 'L' },
      ...
      c = custom_getopt_long (argc, argv, "hVp:o:s:t:Rr::Ll::", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* Define the product input method.  */
        
        
          if (update_arg( (void *)&(args_info->product_arg), 
               &(args_info->product_orig), &(args_info->product_given),
              &(local_args_info.product_given), optarg, 0, 0, ARG_STRING,
        ...
        case 'o':	/* Select the output file format(s).  */
          ...
          break;
        case 's':	/* Define the outer strategy to compute stage models..  */
        
        
          if (update_arg( (void *)&(args_info->outer_strategy_arg), 
               &(args_info->outer_strategy_orig), &(args_info->outer_strategy_given),
              &(local_args_info.outer_strategy_given), optarg, cmdline_parser_outer_strategy_values, "forwards", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "outer-strategy", 's',
              additional_error))
            goto failure;
          ...
          break;
        case 't':	/* Define the inner strategy to compute stage models..  */
        
        
          if (update_arg( (void *)&(args_info->inner_strategy_arg), 
               &(args_info->inner_strategy_orig), &(args_info->inner_strategy_given),
              &(local_args_info.inner_strategy_given), optarg, cmdline_parser_inner_strategy_values, "last", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "inner-strategy", 't',
              additional_error))
            goto failure;
          ...
          break;
        case 'R':	/* Prints result to stdout..  */
        
        
          if (update_arg((void *)&(args_info->Result_flag), 0, &(args_info->Result_given),
              &(local_args_info.Result_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "Result", 'R',
              additional_error))
            goto failure;
        
          break;
        case 'r':	/* Prints result to specified file. If no filename is given, it will be derived from the input file..  */
        ...
        case 'L':	/* Prints log to stdout.  */
          ...
          break;
        case 'l':	/* Prints result to specified file. ....  */
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "try-all") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->try_all_flag), 0, &(args_info->try_all_given),
                &(local_args_info.try_all_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "try-all", '-',
                additional_error))
              goto failure;
          
          }
          /* If flag is given, all stage models for a given sequence are computed..  */
          else if (strcmp (long_options[option_index].name, "all-given-sequence") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->all_given_sequence_flag), 0, &(args_info->all_given_sequence_given),
                &(local_args_info.all_given_sequence_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "all-given-sequence", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "csv") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->csv_arg), 
                 &(args_info->csv_orig), &(args_info->csv_given),
                &(local_args_info.csv_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "csv", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "basepath") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->basepath_arg), 
                 &(args_info->basepath_orig), &(args_info->basepath_given),
                &(local_args_info.basepath_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "basepath", '-',
                additional_error))
              goto failure;
